...
exports.sha256t = function(buffer){
    return exports.sha256(exports.sha256d(buffer));
};

exports.sha256q = function(buffer){
    return exports.sha256(exports.sha256t(buffer));
};
